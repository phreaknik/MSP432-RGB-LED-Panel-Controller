...
extern void DISP__fillPixel(DISP__imgBuf *buf, const DISP__PDMcolor *color, int X, int Y);
extern void DISP__drawLine(DISP__imgBuf *buf, const DISP__PDMcolor *color, int X0, int Y0, int X1, int Y1);
extern void DISP__fillLine(DISP__imgBuf *buf, const DISP__PDMcolor *color, int X0, int Y0, int X1, int Y1);
